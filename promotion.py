...
def rfm_score(uid):
    ...
    user = pd.read_csv('s3://admfinalproject/Dataset/user_details.csv')
    rfm = pd.read_csv('s3://admfinalproject/Dataset/customer_segmented.csv')
    promotion = pd.read_csv('s3://admfinalproject/Dataset/promotion.csv')
